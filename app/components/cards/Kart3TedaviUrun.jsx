  ...
  return (
    <details className="acc" id="acc_productprep" style={{ marginBottom: '12px' }}>
      ...
      <div className="accBody">
        ...
        {selectedUrun && (
          <div style={{ marginTop: '20px' }}>
            <label>Rakip Ürün Bilgileri</label>
            <div style={{ display: 'flex', gap: '10px', flexWrap: 'wrap' }}>

              {/* Rakip Adı */}
              <div style={{ flex: 1, minWidth: '140px' }}>
                <div style={{ fontSize: '11px', color: '#888', marginBottom: '4px' }}>Ürün Adı</div>
                <input
                  type="text"
                  value={selectedRakip}
                  onChange={e => handleRakipChange(e.target.value)}
              ...
              {/* Etken Madde */}
              <div style={{ flex: 1, minWidth: '140px' }}>
                <div style={{ fontSize: '11px', color: '#888', marginBottom: '4px' }}>Etken Madde</div>
                <input
                  type="text"
                  value={selectedRakipEtken}
                  onChange={e => setSelectedRakipEtken(e.target.value)}
